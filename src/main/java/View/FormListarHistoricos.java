 ...
 * @author natha
 */
public class FormListarHistoricos extends javax.swing.JFrame {
    
    HistoricoController histController = new HistoricoController();
    ...
    private void pesquisar(){
        List<Historico>lstHistoricos = new ArrayList<>();
        ...
        if(livro.getNome() != null && leitor.getNome() != null){
            ...
            lstHistoricos = histController.getHistoricos(estante);
            preencherTabela(lstHistoricos);
        }
        else if(livro.getNome() == null && leitor.getNome() != null){
            List<Estante>lstEstante = estanteController.getEstantes(leitor);
            List<Historico>lstAuxHist;
            for(Estante itemEstante : lstEstante){
                lstAuxHist = histController.getHistoricos(itemEstante);
                for(Historico itemHist : lstAuxHist){
                    lstHistoricos.add(itemHist);
                }
            }
            preencherTabela(lstHistoricos);
        }
            ...
            lstHistoricos = histController.getHistoricos();
            preencherTabela(lstHistoricos);
        }
    }
    
    private void preencherTabela(List<Historico> lstP){
        DefaultTableModel tabelaHistoricos = (DefaultTableModel)tabHistoricos.getModel();
        tabHistoricos.getColumnModel().getColumn(0).setPreferredWidth(60);
        tabHistoricos.getColumnModel().getColumn(1).setPreferredWidth(60);
        tabHistoricos.getColumnModel().getColumn(2).setPreferredWidth(20);
        tabHistoricos.getColumnModel().getColumn(3).setPreferredWidth(200);
        tabelaHistoricos.setNumRows(0);
        
        lstP.forEach(itemHistorico ->{
            tabelaHistoricos.addRow(new Object[]{itemHistorico.getEstante().getLeitor().getNome(), itemHistorico.getEstante().getLivro().getNome(), itemHistorico.getPorcentagemLeitura(), itemHistorico.getComentario()});
        });
    }
    
    public FormListarHistoricos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabHistoricos = new javax.swing.JTable();
        ...
        tabHistoricos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, "", ""},
                {null, null, "", ""},
                {null, null, "", ""}
            ...
            new String [] {
                "Leitor", "Livro", "%", "Comentário"
            }
        ));
        tabHistoricos.setGridColor(new java.awt.Color(102, 102, 102));
        tabHistoricos.setShowGrid(true);
        jScrollPane2.setViewportView(tabHistoricos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormListarHistoricos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabHistoricos;
